...
p = ggplot(meltdf,aes(x=Date, 
  ...
  ggtitle("Pron\u00F3stico de PIB Trimestral dentro de muestra: 4 trimestres") + 
  theme(
...
if(getOutputFormat() == 'html_document') {
  ggplotly(p)  %>%
    layout(title = "Pron\u00F3stico de PIB Trimestral dentro de muestra: 4 Trimestres",
           xaxis = list(title = ""),
           yaxis = list (title = "%"))
 } else {
  p
